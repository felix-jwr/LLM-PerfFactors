...
- Single GPU: `docker run --rm --gpus device=6 --user $(id -u):$(id -g) -v $(pwd)/out:/app/out fr411/masters-thesis -d`
- Multiple GPUs: `docker run --rm --gpus '"device=6,7"' --user $(id -u):$(id -g) -v $(pwd)/out:/app/out fr411/masters-thesis -d`