...
- Single GPU: `hare run --rm --gpus device=6 --user $(id -u):$(id -g) -v $(pwd):/app fr411/masters-thesis -d`
- Multiple GPUs: `hare run --rm --gpus '"device=6,7"' --user $(id -u):$(id -g) -v $(pwd):/app fr411/masters-thesis -d`